package com.st.slex.common.messenger.single_chat.model

import android.util.Log
import androidx.lifecycle.MutableLiveData
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.ServerValue
import com.st.slex.common.messenger.activity.activity_model.ActivityConst.CHILD_FROM
...
import com.st.slex.common.messenger.activity.activity_model.ActivityConst.CHILD_TEXT
import com.st.slex.common.messenger.activity.activity_model.ActivityConst.CHILD_TIMESTAMP
import com.st.slex.common.messenger.activity.activity_model.ActivityConst.CURRENT_UID
import com.st.slex.common.messenger.activity.activity_model.ActivityConst.NODE_MAIN_LIST
import com.st.slex.common.messenger.activity.activity_model.ActivityConst.NODE_MESSAGES
...
import com.st.slex.common.messenger.utilites.AppChildEventListener
    ...
    fun initStatus(uid: String) {
        REF_DATABASE_ROOT
            ...
            .addValueEventListener(AppValueEventListener {
                status.value = it.value as String?
            })
    }
