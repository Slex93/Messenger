...
interface LoginEngine {
    ...
    abstract class Abstract(activity: AuthActivity) : LoginEngine {
    ...
    class Login(activity: AuthActivity) : Abstract(activity) {
        ...
        private suspend fun authInternal(activity: AuthActivity) =
    ...
    class SignIn(activity: AuthActivity) : Abstract(activity) {
